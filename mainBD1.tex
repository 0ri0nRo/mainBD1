...
\begin{itemize}
  ...
  \begin{enumerate}
    ...
    \end{itemize}
      ...
      \begin{figure}[hbt]
        \begin{center}
            \includegraphics[width=0.8\textwidth,keepaspectratio]{{im/2}}
        \end{center}
        \end{figure}
  \end{enumerate}
\end{itemize}
...
\begin{figure}[hbt]
  \begin{center}
      \includegraphics[width=0.7\textwidth,keepaspectratio]{{im/3}}
  \end{center}
  \end{figure}
  \begin{figure}[hbt]
    \begin{center}
        \includegraphics[width=0.7\textwidth,keepaspectratio]{{im/4}}
    \end{center}
    \end{figure}
