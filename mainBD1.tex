...
Proviamo se legale:
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item Se $t_1[V] = t_2[V]$ allora è verificato che $V \subseteq Z_i$. Otteniamo così che $W \subseteq SS_i$, come ciascun attributo $B \in W$ è aggiunto a $S_i$ ciò significa che $V \rightarrow W \in F$
